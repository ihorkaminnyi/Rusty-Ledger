  ...
  <div class="w-full">
    <div class="grid align-items-stretch">
      <div class="col-12 md:col-6 lg:col-4">
        <div
            class="surface-0 border-1 surface-border border-round-lg p-4 h-full transition-all transition-duration-300 hover:shadow-3 hover:-translate-y-1 flex flex-column justify-content-between gap-3">
      ...
      <div class="col-12 md:col-6 lg:col-4">
        <div
          ...
          <div
            ...
            <div class="text-base font-medium opacity-80 mt-1">{{ formattedUnrealizedPLPercent }}</div>
          </div>
        </div>
      </div>
