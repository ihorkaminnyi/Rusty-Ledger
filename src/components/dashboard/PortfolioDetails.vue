...
const hasPositions = computed(
    () => (portfolio.value?.positions.length ?? 0) > 0,
);
...
<template>
    <Card
        class="surface-0 border-1 surface-border border-round-xl shadow-2 overflow-hidden"
    >
        <template #content>
            <div
                v-if="hasPositions"
                class="overflow-auto border-1 surface-border border-round-xl"
            >
                    ...
                    <TabPanel value="details">
                        ...
                        >
                            ...
                            >
                                <template #body="{ data }">
                                    <span
                                        :class="getPLClass(data.unrealizedPl)"
                                    >
                                        {{
                                            formatCurrency(
                                                data.unrealizedPl,
            ...
            <div v-else class="text-center py-6 text-600">
                ...
                <p class="text-sm line-height-3">
                    Upload a portfolio CSV file to see your detailed positions.
                </p>
            </div>
        </template>
    </Card>
