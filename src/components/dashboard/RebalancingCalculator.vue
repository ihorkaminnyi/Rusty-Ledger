...
watch(() => rebalancingState.hasCalculated, (isCalculated) => {
...
<template>
  <div class="flex flex-column gap-4">
    ...
    <div class="flex flex-column">
      ...
      <div class="flex justify-content-center gap-2 pt-3 border-top-1 surface-border flex-wrap">
        <Button
    ...
    >
      ...
      <div v-if="formattedActions.length">
        <DataTable
            ...
            size="small"
        >
          <Column field="action" header="Action" :style="{ minWidth: '6rem' }">
            <template #body="{ data }">
              <Tag
          ...
          <Column field="symbol" header="Asset" :style="{ minWidth: '5rem' }">
            <template #body="{ data }">
              <div class="symbol-main">{{ data.symbol }}</div>
            </template>
          </Column>

          <Column field="amount" header="Amount" :style="{ minWidth: '6rem' }">
            <template #body="{ data }">
          ...
          <Column field="shares" header="Shares" :style="{ minWidth: '5rem' }">
            <template #body="{ data }">
          ...
          <Column field="currentPercent" header="Current %" :style="{ minWidth: '6rem' }">
            <template #body="{ data }">
              <div class="current-percent">
                {{ formatPercentage(data.currentPercent) }}
              </div>
          ...
          <Column field="targetPercent" header="Target %" :style="{ minWidth: '5rem' }">
            <template #body="{ data }">
